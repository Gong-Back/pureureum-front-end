const {
  NEXT_KAKAO_CLIENT_ID: KAKAO_CLIENT_ID,
  NEXT_KAKAO_REDIRECT_URL: KAKAO_REDIRECT_URL,
  NEXT_NAVER_CLIENT_ID: NAVER_CLIENT_ID,
  NEXT_NAVER_REDIRECT_URL: NAVER_REDIRECT_URL,
  NEXT_GOOGLE_CLIENT_ID: GOOGLE_CLIENT_ID,
  NEXT_GOOGLE_REDIRECT_URL: GOOGLE_REDIRECT_URL,
} = process.env;
